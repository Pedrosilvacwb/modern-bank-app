...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <h2 className="font-poppins font-semibold ss:text-[64px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">
        Payment Method.
      </h2>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <img
        src={robot}
        alt="billing"
        className="w-[100%] h-[100%] relative z-[5] relative"
      />
